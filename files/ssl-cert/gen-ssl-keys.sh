...
AuthorityDays=3650
# modified  server expiration is 10 years
CertDays=3650
...
showUsage()
{
    ...
    See /usr/share/doc/sipxecs/INSTALL.ssl.{txt,html} for details on usage.
...
Results:
  ...
  and then run this command as root in this directory:
      ...
      /usr/bin/ssl-cert/install-cert.sh ${serverName}${restrictionName}
